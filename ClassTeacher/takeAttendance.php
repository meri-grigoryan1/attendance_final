       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ստուգել հաճախելիությունը (Այսօր՝ <?php echo $todaysDate = date("m-d-Y");?>)</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Տուն</a></li>
              <li class="breadcrumb-item active" aria-current="page">Բոլոր ուսանողները կուրսում</li>
            </ol>
          </div>
            ...
            <div class="row">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Բոլոր ուսանողները (<?php echo $rrw['className'].' - '.$rrw['classArmName'];?>) կուրսում</h6>
                  <h6 class="m-0 font-weight-bold text-danger">Նշում: <i> յուրաքանչյուր ուսանողի կողքին սեղմեք վանդակների վրա՝ ներկա նշելու համար:</i></h6>
                </div>
                ...
                <?php echo $statusMsg; ?>
                  ...
                  <br>
                  <button type="submit" name="save" class="btn btn-primary">Վերջացնել</button>
                  </form>
                </div>
              </div>
            </div>
