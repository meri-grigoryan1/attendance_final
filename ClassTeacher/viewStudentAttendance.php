       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Դիտել ուսանողի առաջադիմությունը</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Տուն</a></li>
              <li class="breadcrumb-item active" aria-current="page">Դիտել ուսանողի առաջադիմությունը</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Դիտել ուսանողի առաջադիմությունը</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Ընտրել ուսանողին<span class="text-danger ml-2">*</span></label>
                        <?php
                        ...
                        if ($num > 0){
                          ...
                          echo'<option value="">--Ընտրեք ուսանողին--</option>';
                        ...
                        <label class="form-control-label">Type<span class="text-danger ml-2">*</span></label>
                          ...
                          <option value="2" >Ըստ ամսաթվի</option>
                          <option value="3" >Ըստ ժամանակահատվածի</option>
                        </select>
                        </div>
                    </div>
                      <?php
                    ...
                    <button type="submit" name="view" class="btn btn-primary">Դիտել հաճախելիությունը</button>
                  </form>
                </div>
              </div>
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Կուրսի հաճախելիություն</h6>
                </div>
                    ...
                    if(isset($_POST['view'])){
                      ...
                      { 
                        while ($rows = $rs->fetch_assoc())
                          {
                              if($rows['status'] == '1'){$status = "Ներկա"; $colour="#00FF00";}else{$status = "Բացակա";$colour="#FF0000";}
                             $sn = $sn + 1;
                            echo"
                              <tr>
                                <td>".$sn."</td>
